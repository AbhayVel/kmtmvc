...
{
    public class KMI4ActionFilter :   IActionFilter
    {
        ...
        public  void OnActionExecuted(ActionExecutedContext filterContext)
        {
         ...
         //   filterContext.HttpContext.Response.Write("I am in OnActionExecuted4 <br>");

            filterContext.HttpContext.Response.Headers.Add("ActionTime4", (End - Start).TotalMilliseconds.ToString());
        }
        //
        // Summary:
        ...
        {
         //   filterContext.HttpContext.Response.Write("I am in OnActionExecuting4 <br>");
            Start = DateTime.Now;
        }
